...
public class Client {
     ...
     */
    private static String getResponse(String req) throws RemoteException, InterruptedException {
        Thread.sleep(300);
        ...
        switch (cmd) {
            case "put":
                ...
                return String.format("Response for %s: <%s>", req, server.put(key, value));
            case "get":
                return String.format("Response for %s: <%s>", req, server.get(key));
            case "delete":
                return String.format("Response for %s: <%s>", req, server.delete(key));
            default:
     ...
     * @throws IllegalArgumentException throws an exception if the request is invalid
     */
