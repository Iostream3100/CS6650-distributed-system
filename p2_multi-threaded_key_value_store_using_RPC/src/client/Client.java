...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
        try {
            initConfig(args);
            db = (KeyValue) Naming.lookup("rmi://" + ip + ":" + port + "/keyValue");
    ...
    private static String getResponse(String req) throws RemoteException {
        ...
        switch (cmd) {
            case "put":
                ...
                return String.format("[Success] Response for %s: %s", req, db.put(key, value));
            case "get":
                return String.format("[Success] Response for %s: %s", req, db.get(key));
            case "delete":
                return String.format("[Success] Response for %s: %s", req, db.delete(key));
            default:
